...
public class AtomImpl extends BooleanExpressionImpl implements Atom
{
    ...
    if (operator != null && operator.eIsProxy())
    {
      ...
      if (operator != oldOperator)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainmodelPackage.ATOM__OPERATOR, oldOperator, operator));
      }
    }
    return operator;
  }
  ...
  public void setOperator(Operator newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DomainmodelPackage.ATOM__OPERATOR, oldOperator, operator));
  }
