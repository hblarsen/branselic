...
@after {
	...
	(
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getRuleAccess().getIfBooleanExpressionParserRuleCall_1_0());
				}
				lv_if_2_0=ruleBooleanExpression
				{
					if ($current==null) {
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getRuleAccess().getThenBooleanExpressionParserRuleCall_3_0());
				}
				lv_then_4_0=ruleBooleanExpression
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getRuleRule());
					}
...
@after {
	...
	(
		...
		this_Or_3=ruleOr
		{
		    ...
		    |
		{
			newCompositeNode(grammarAccess.getBooleanExpressionAccess().getNegationParserRuleCall_4());
		}
...
@after {
	...
	(
		(
			(
				{
					newCompositeNode(grammarAccess.getOrAccess().getBooleanexpressionSimpleBooleanParserRuleCall_0_0());
				}
				lv_booleanexpression_0_0=ruleSimpleBoolean
				{
					if ($current==null) {
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getOrAccess().getBooleanexpressionSimpleBooleanParserRuleCall_2_0());
				}
				lv_booleanexpression_2_0=ruleSimpleBoolean
				{
					if ($current==null) {
