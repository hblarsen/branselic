...
public class ConfiguratorLangSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DomainmodelPackage.eINSTANCE)
			...
			case DomainmodelPackage.BOOLEAN_EXPRESSION:
				sequence_Or(context, (BooleanExpression) semanticObject); 
				return; 
	 ...
	 *     SimpleBoolean returns BooleanExpression
	 *     Or returns BooleanExpression
	 *
	 * Constraint:
	 *     (booleanexpression+=SimpleBoolean booleanexpression+=SimpleBoolean)
	 */
	protected void sequence_Or(ISerializationContext context, BooleanExpression semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
